...
const Testimonial = () => {
  return (
    ...
    pt-20 pb-30'>
      <Title title="What Our Guest Say" subTitle= "Discover why discerning travelers consistently choose QuickStack for their exclusive and luxurious accomodations around the world" />
