...
const AddRoom = () => {
  ...
  return (
   <form>
    <Title align='left' font='outfit'  title='Add Room' subTitle='Fiil 
    in the details carfully and accurate room details, pricing, and amenities, to enhance the user booking experience.'/>
    {/* {Upload area for images} */}
    <p className='text-gray-800 mt-10'> Images</p>
    <div className='grid grid-cols sm:flex gap-4 my-2 flex-wrap'>
        {Object.keys(images).map((key)=>(
            <label htmlFor={`roomImage${key}`}key={key}>
                ...
                onClick={e=> setImages({...images, [key]: e.target.files[0]})} />
            </label>
        ))}
    </div>
    ...
    <div className='w-full flex max-sm:flex-col sm:gap-4 mt-4'>
        <div className='flex-1 max-w-48'>
            ...
            <select  onChange={e=> setInputs({...inputs,roomType: e.target.value})}
             className='border opacity-70 border-gray-300 mt-1 rounded p-2 w-full' name={inputs.roomType}  id="">
