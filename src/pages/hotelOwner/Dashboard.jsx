...
const Dashboard = () => {
  ...
  return (
    <div>
      ...
      room listings, track bookings and analyse revenue-all in one place. Stay updated with real-time
            ...
            <table className='w-full'>
                <thead className='bg-gray-50'>
                    <tr>
                        ...
                        <th className='py-3 px-4 text-gray-800 font-medium max-sm:hidden'>Room Name</th>                      <th className='py-3 px-4 text-gray-800 font-medium'>User Name</th>
